...
func (x *HighestAttestation) GetHighestSourceEpoch() github_com_OffchainLabs_prysm_v6_consensus_types_primitives.Epoch {
	if x != nil {
...
func (x *HighestAttestation) GetHighestTargetEpoch() github_com_OffchainLabs_prysm_v6_consensus_types_primitives.Epoch {
	if x != nil {
