...
func (x *SignRequest) GetSlot() github_com_OffchainLabs_prysm_v6_consensus_types_primitives.Slot {
...
func (x *SignRequest) GetEpoch() github_com_OffchainLabs_prysm_v6_consensus_types_primitives.Epoch {
...
func (x *BuilderConfig) GetGasLimit() github_com_OffchainLabs_prysm_v6_consensus_types_validator.Uint64 {
	if x != nil {
		return x.GasLimit
	}
	return github_com_OffchainLabs_prysm_v6_consensus_types_validator.Uint64(0)
}
